...
@section('content')
<main>
    @if(!empty(count($project_sliders)))
    ...
    @endif
    <div class="container-fluid project__intro mb-0">
        <div class="row custom-row justify-content-center">
            <div class="col-12 col-md-11 col-lg-10 text-center">
                <div class="project__intro__logo mb-5" data-scroll data-scroll-speed="1">
                    <img loading="lazy" src="{{url('/')}}/assets/images/projects/{{$project->project_logo}}" alt="{{$project->project_name}}" class="img-fluid" width="289" height="111">
                </div>
        ...
        <div class="row custom-row project__intro__info mt-5">
            <div class="col-12 col-md-7 col-lg-7">
                ...
                <div class="row project__intro__info__cta mt-5">
                    ...
                    <div class="col-12 col-md-6">
                        <a class="link show_pointer download_brochure_config" data-type="1" data-id="{{$project->id}}">download Brochure <span><img loading="lazy" src="{{url('/')}}/assets/images/home/download-brochure.png" alt="Download" class="img-fluid" width="26" height="28"></span></a>
                    </div>
                    @endif
                    @if(!empty($project->project_3d_walk))
                    <div class="col-12 col-md-6 walkthrough">
                        <a class="link" data-iframe="{{$project->project_3d_walk}}">Take a Tour <span><img loading="lazy" src="{{url('/')}}/assets/images/home/360-degrees.png" alt="Take A Tour" class="img-fluid" width="43" height="32"></span></a>
                    </div>
                    @endif
                </div>
            </div>
            <div class="col-12 col-md-5 col-lg-5">
                <div class="project__intro__info__img" data-scroll data-scroll-speed="1.5">
                    <img loading="lazy" src="{{url('/')}}/assets/images/projects/{{$project->project_about_image}}" alt="{{$project->project_name}}" class="img-fluid" width="636" height="560">
                </div>
            </div>
        </div>
        @endif
    ...
    <div class="container-fluid project__videos">
        <div class="row custom-row">
            ...
            <div class="col-12 project__videos__slider owl-carousel owl-theme">
                ...
                <div class="project__videos__slider__item">
                    <img loading="lazy" src="{{url('/')}}/assets/images/projects/{{$project_video_slider_row->project_video_thumbnail}}" alt="{{$project_video_slider_row->project_video_title}}" class="img-fluid" width="320" height="180">
    ...
    <div class="container-fluid project__amenities">
        <div class="row custom-row">
            ...
            <div class="col-8 project__amenities__nav">
                ...
                <span class="slide_left"><img loading="lazy" src="{{url('/')}}/assets/images/home/Arrow.png" alt="Left" class="img-fluid" width="35" height="25"></span>
                <span class="slide_right"><img loading="lazy" src="{{url('/')}}/assets/images/home/Arrow.png" alt="right" class="img-fluid" width="35" height="25"></span>
                @endif
            </div>
        </div>
        <div class="project__amenities__slider owl-carousel owl-theme">
            ...
            <div class="row m-0">
                <div class="col-12 col-md-6 p-0 project__amenities__image" data-scroll-repeat data-scroll data-scroll-class="inView">
                    <img loading="lazy" src="{{url('/')}}/assets/images/projects/{{$project_highlighted_amenity_row->project_amenity_image}}" alt="{{$project_highlighted_amenity_row->project_amenity_title}}" class="img-fluid" width="960" height="760">
                </div>
                <div class="col-12 col-md-6 p-0 project__amenities__text">
                    <div class="project__amenities__text__inner">
                        <h3 class="heading-primary mb-5">{{$project_highlighted_amenity_row->project_amenity_title}}</h3>
    ...
    <div class="container-fluid project__experience">
        ...
        <div class="row custom-row project__experience__section">
            ...
            <div class="col-6 col-md-3 project__experience__section__block text-center">
                <img loading="lazy" src="{{url('/')}}/assets/images/projects/{{$project_amenity_row->project_amenity_image}}" alt="{{$project_amenity_row->project_amenity_title}}" class="img-fluid" data-scroll data-scroll-speed="1" width="100" height="100">
    ...
    <div class="container-fluid project__gallery">
        <div class="row custom-row project__gallery__tabs  mb-5 mt-5" id="filters" data-scroll data-scroll-speed="1.3">
            ...
            <div class="row grid project__gallery__lists__section active" id="Apartments" data-scroll-speed=".2" data-scroll-offset="5%" data-scroll-repeat data-scroll data-scroll-class="inView">
                ...
                <div class="project__gallery__lists__section__item {{$project_gallery_row->project_gallery_category_title}}">
                    <a data-magnify="project-gallery" data-caption="{{$project_gallery_row->project_gallery_caption}}" href="{{url('/')}}/assets/images/projects/{{$project_gallery_row->project_gallery_image}}" class="project__gallery__lists__section__item__inner">
                        <img loading="lazy" src="{{url('/')}}/assets/images/projects/{{$project_gallery_row->project_gallery_image}}" alt="{{$project_gallery_row->project_gallery_caption}}" class="img-fluid" width="636" height="560">
                ...
                <div class="row align-items-center">
                    <div class="col-1">
                        <span class="prev__plan disabled">
                            <img loading="lazy" src="{{url('/')}}/assets/images/home/plan-arrow-left.png" alt="Previous Plan" class="img-fluid" width="33" height="25">
                        </span>
                    </div>
                    ...
                    <div class="col-1">
                        <span class="next__plan">
                            <img loading="lazy" src="{{url('/')}}/assets/images/home/plan-arrow-right.png" alt="Next Plan" class="img-fluid" width="33" height="25">
                        </span>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-12 col-md-9 plan__image">
                            <div class="plan__image__block">
                                 ...
                                 <a data-magnify="plans-gallery" data-caption="{{$project_plan_row->project_layout_title}}" href="{{url('/')}}/assets/images/projects/{{$project_plan_row->project_layout_image}}">
                                    <img loading="lazy" src="{{url('/')}}/assets/images/projects/{{$project_plan_row->project_layout_image}}" alt="{{$project_plan_row->project_layout_title}}" class="img-fluid" width="1920" height="1080">
                                </a>
                            </div>
                        </div>
                    </div>
    ...
    @endif
    @if(!empty($project->project_location_iframe))
    <div class="container-fluid project__connectivity">
    ...
    <div class="container-fluid social_projects project__faqs" data-scroll data-scroll-speed="1">
        ...
        <div class="row custom-row">
            ...
            <div class="social_projects__block project">
                <div class="social_projects__block__title">
                    <span></span>
                    <h4 class="paragraph">{{$project_faq_row->project_faq_question}}</h4>
                </div>
    ...
    @endif
    <div class="container-fluid project__enquiry" data-scroll-offset="5%" data-scroll-repeat data-scroll
