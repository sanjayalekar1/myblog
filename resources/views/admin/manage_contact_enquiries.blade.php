...
@section('title', 'Manage Contact Enquiries')
@section('content')
<section class="content-header">
    <h1>Manage Contact Enquiries</h1>
    <ol class="breadcrumb">
        ...
        <div class="box">
            <div class="box-header">
                <div class="box-tools" style="float: right;">
                    <a class="btn btn-default" href="{{Config::get('constants.admin_url')}}export-contact-enquiries">Export Contact Enquiries</a>
                </div>
            </div><!-- /.box-header -->
