...
<section class="content">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 connectedSortable">
        <div class="box box-primary">
            ...
            <form id="add_management" class="hideformspan" enctype="multipart/form-data">
                @csrf
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input name="management_name" id="management_name">
                        <span id="management_name_err"></span>
                    </div>
                    <div class="form-group">
                        <label for="management_thumbnail">Management Thumbnail*</label>
                        <input type="file" name="management_thumbnail" id="management_thumbnail" accept="image/*" required>
                        <span id="management_thumbnail_err"></span>
                    </div>
                    <div class="form-group">
                        <label>Management Designation*</label>
                        <input type="text" name="management_designation" id="management_designation">
                        <span id="management_designation_err"></span>
                    </div>
                    <div class="form-group">
                        <label>Management Description*</label>
                        <textarea name="management_description" id="management_description"></textarea>
                        <span id="management_description_err"></span>
                    </div>
                    <div class="form-group">
                        <label>Management Linked IN</label>
                        <input type="url" name="management_linked_in" id="management_linked_in">
                        <span id="management_linked_in_err"></span>
                    </div>
                    <div class="form-group">
                        <label>Management Twitter</label>
                        <input type="url" name="management_twitter" id="management_twitter">
