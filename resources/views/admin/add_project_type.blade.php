...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Add Project Type</li>
    </ol>
</section>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 connectedSortable">
        <div class="box box-primary">
            <div class="box-header">
                <h3 class="box-title">Add Project Type</h3>
                <div class="box-tools"></div>
            </div>
            <form id="add_project_type" class="hideformspan" enctype="multipart/form-data">
                @csrf
                <div class="box-body">
                    <div class="form-group">
                        <label>Type Title</label>
                        <input name="project_type_title" id="project_type_title">
