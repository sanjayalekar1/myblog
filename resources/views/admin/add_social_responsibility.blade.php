...
@section('title', 'Add Social Responsibility')
@section('content')
<section class="content-header">
    <h1>Add Social Responsibility</h1>
    <ol class="breadcrumb">
        ...
        <li class="active">Add Social Responsibility</li>
    </ol>
</section>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 connectedSortable">
        <div class="box box-primary">
            <div class="box-header">
                <h3 class="box-title">Add Social Responsibility</h3>
                <div class="box-tools"></div>
            </div>
            <form id="add_social_responsibility" class="hideformspan" enctype="multipart/form-data">
                @csrf
                <div class="box-body">
